...
public class SiteServiceImpl implements ISiteService {
  ...
  public BackResponseBo backup(String bk_type, String bk_path, String fmt) throws Exception {
    ...
    String bkAttachDir = TaleUtils.getWebSiteRootPath() + "/upload/";
    String bkThemesDir = TaleUtils.getWebSiteRootPath() + "templates/themes";
    ...
    if (bk_type.equals("attach")) {
      ...
      String fname =
              DateKit.dateFormat(new Date(), fmt) + "_" + TaleUtils.getRandomNumber(5) + ".zip";
